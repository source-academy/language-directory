...
const source4Default: IEvaluatorDefinition = {
    ...
    capabilities: [],
    welcome: `You have chosen the **Default** evaluator for JavaScript §4, which compiles your program to JavaScript and runs it on the browser's own JavaScript engine.`
};
...
const source4Cse: IEvaluatorDefinition = {
    ...
    welcome: `You have chosen the **CSE machine** evaluator for JavaScript §4, which runs your program step by step so the Control, Stash and Environment can be visualised.`
};
...
The book [_Structure and Interpretation of Computer Programs, JavaScript Edition_](https://sourceacademy.org/sicpjs/) uses restricted [JavaScript sublanguages](https://docs.sourceacademy.org/). You have chosen **JavaScript §4**, matching SICP JS §4.`
};
